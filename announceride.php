            ...
            <div id="articleDiv">
                <article id="contentArticle">
                    ...
                    <section id="contentSection">
                        <form action="saveride.php" method="post">
							Start Point *<br>
							<input type="text" name = "startp" placeholder="Start Point" required><br>

							End Point * <br>
							<input type="text" name = "endp" placeholder="End Point" required><br>
							
							Date *<br>
							<input type="date" name = "dateofride" placeholder="Date" required><br>

							Time *<br>
							<input type="time" name = "timeofride" placeholder="Time" required><br>

							Capacity *<br>
							<input type="number" name = "capacity" min="1" max="30" placeholder="Capacity" required><br>
